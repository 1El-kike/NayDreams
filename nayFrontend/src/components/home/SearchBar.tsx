...
export const SearchBar = () => {
    ...
    return (
        <div className="relative">
            <img alt="Dreams fondo" className="absolute animate-none top-0 left-0 w-full  h-full object-cover  mask-radial-[100%100%]  mask-radial-from-25% mask-radial-at-top" src={fondo_lona} />
